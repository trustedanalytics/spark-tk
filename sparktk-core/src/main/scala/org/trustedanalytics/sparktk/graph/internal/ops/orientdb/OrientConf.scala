 ...
 */
case class OrientConf(dbUri: String, dbUserName: String, dbPassword: String, rootPassword: String, dbProperties: Option[Map[String, Any]] = None) extends Serializable {
