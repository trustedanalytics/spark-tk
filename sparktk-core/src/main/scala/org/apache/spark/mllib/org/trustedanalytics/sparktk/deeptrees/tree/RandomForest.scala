...
import org.apache.spark.ml.org.trustedanalytics.sparktk.deeptrees.tree.{ DecisionTreeModel => NewDTModel, RandomForestParams => NewRFParams }
...
import org.apache.spark.mllib.org.trustedanalytics.sparktk.deeptrees.tree.impurity.Impurities
...
private class RandomForest(
  ...
  def run(input: RDD[LabeledPoint]): RandomForestModel = {
    val trees: Array[NewDTModel] = NewRandomForest.run(input, strategy, numTrees,
