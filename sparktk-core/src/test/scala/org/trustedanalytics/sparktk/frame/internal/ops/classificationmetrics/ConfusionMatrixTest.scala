...
class ConfusionMatrixTest extends TestingSparkContextWordSpec with Matchers {
  ...
  "confusion matrix" should {
    "compute predicted vs. actual class for binary classifier" in {
    ...
    "compute predicted vs. actual class for binary classifier with string labels" in {
    ...
    "compute predicted vs. actual class for multi-class classifier" in {
    ...
    "compute predicted vs. actual class for multi-class classifier with string labels" in {
