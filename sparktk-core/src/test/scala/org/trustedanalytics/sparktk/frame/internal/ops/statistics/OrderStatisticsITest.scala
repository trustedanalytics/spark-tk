 ...
 * bad weights).
 */
class OrderStatisticsITest extends TestingSparkContextWordSpec with Matchers {

  "OrderStatistics" should {
    "handle even number of data elements" in {
