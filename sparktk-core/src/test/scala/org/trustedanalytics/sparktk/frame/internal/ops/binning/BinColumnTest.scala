...
class BinColumnTest extends TestingSparkContextWordSpec with Matchers {

  "binEqualWidth" should {
    "append new column" in {
      // Input data
      val inputList = List(
        Array[Any]("A", 1),
        Array[Any]("B", 2),
    ...
    "create the correct number of bins" in {
      // Input data
      val inputList = List(
        Array[Any]("A", 1),
        Array[Any]("B", 2),
    ...
    "throw error if less than one bin requested" in {
      // Input data
      val inputList = List(
        Array[Any]("A", 1),
        Array[Any]("B", 1.5),
    ...
    "throw error if attempting to bin non-numeric column" in {
      // Input data
      val inputList = List(
        Array[Any]("A", 1),
        Array[Any]("B", 1.5),
    ...
    "put each element in separate bin if num_bins is greater than length of column" in {
      // Input data
      val inputList = List(
        Array[Any]("A", 1),
        Array[Any]("B", 2),
  ...
  "binEqualDepth" should {
    ...
    "bin identical values in same bin, even if it means creating fewer than requested bins" in {
      // Input data
      val inputList = List(
        Array[Any]("A", 1),
        Array[Any]("B", 1),
    ...
    "create equal depth bins - another test" in {
      // Input data
      val inputList = List(
        Array[Any]("A", 1),
        Array[Any]("B", 2),
    ...
    "put each value in separate bin if num_bins is greater than length of column" in {
      // Input data
      val inputList = List(
        Array[Any]("A", 1),
        Array[Any]("B", 2),
  ...
  "binColumn" should {
    "place values outside of cutoffs into first of last bin when strictBinning is false" in { // Input data
      val inputList = List(
        Array[Any]("A", 1),
        Array[Any]("B", 2),
        Array[Any]("C", 3),
      ...
      val result = binnedRdd.rdd.collect()
    ...
    "place values outside of cutoffs into bin -1 when strictBinning is true" in { // Input data
      val inputList = List(
        Array[Any]("A", 1),
        Array[Any]("B", 2),
        Array[Any]("C", 3),
    ...
    "be upper inclusive when lowerInclusive is false" in { // Input data
      val inputList = List(
        Array[Any]("A", 1),
        Array[Any]("B", 2),
        Array[Any]("C", 3),
