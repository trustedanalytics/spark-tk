...
class NumericalStatisticsPopulationFormulasITest extends TestingSparkContextWordSpec with Matchers {
  ...
  "NumericalStatistics mean" should {
    "handle data with integer frequencies" in new NumericalStatisticsTestPopulationFormulas {
    ...
    "handle data with fractional weights" in new NumericalStatisticsTestPopulationFormulas {
