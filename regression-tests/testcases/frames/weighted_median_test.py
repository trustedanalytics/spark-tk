...
class WeightedMedians(sparktk_test.SparkTKTestCase):
    ...
    def setUp(self):
        ...
        self.frame_median = self.context.frame.import_csv(dataset1, schema=[("x0", int), ("x1", int)])
        self.frame_median2 = self.context.frame.import_csv(dataset2, schema=[("x0", int), ("x1", int), ("x2", int)])
    ...
    def test_weighted_median_small_data(self):
        ...
        self.assertEqual(weighted_median, 707)
