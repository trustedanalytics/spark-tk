...
class GraphWeightedDegreeTest(atk_test.ATKTestCase):
    ...
    def setUp(self):
        ...
        node_frame = ia.Frame(ia.CsvFile(
            cu.get_file("annotate_node_list.csv"), schema_node))
        ...
        directed_frame = ia.Frame(ia.CsvFile(
            cu.get_file("annotate_directed_list.csv"), schema_directed))
        undirected_frame = ia.Frame(ia.CsvFile(
            cu.get_file("annotate_undirected_list.csv"), schema_undirected))
        directed_label_frame = ia.Frame(ia.CsvFile(
            cu.get_file("annotate_directed_label_list.csv"),
    ...
    def test_annotate_weight_type_error(self):
        ...
        with self.assertRaises(ia.rest.command.CommandServerError):
            self.graph.annotate_weighted_degrees(
                "sumName", edge_weight_property="badvalue")
    ...
    def test_annotate_weight_non_value(self):
        ...
        with self.assertRaises(ia.rest.command.CommandServerError):
            self.graph.annotate_weighted_degrees(
                graph_name, "sumName", edge_weight_property="nonvalue")
