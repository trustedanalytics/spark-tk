...
class DicomDropKeywordsTest(sparktk_test.SparkTKTestCase):
    ...
    def test_filter_one_column_one_result_basic(self):
        ...
        print "keywords: " + str({ "SOPInstanceUID" : random_row_sopi_id })
        ...
        print "exp res: " + str(expected_result) 
        ...
        print "exp res count: " + str(len(expected_result["metadata"]))
    ...
    def test_filter_multiple_columns_basic(self):
        ...
        keyword_filter["BodyPartExamined"] = first_row_institution_name
        ...
        self.dicom.drop_rows_by_keywords(keyword_filter)
        pandas_result = self.dicom.metadata.to_pandas()["metadata"]
