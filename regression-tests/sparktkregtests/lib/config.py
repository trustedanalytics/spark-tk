...
run_mode = (True if os.getenv("RUN_MODE", "yarn_client") == "yarn_client"
            else False)
hostname = os.getenv("HOSTNAME")

# HDFS paths, need to be set NOT using os.join since HDFS doesn't use the
# system path seperator, it uses HDFS path seperator ('/')
