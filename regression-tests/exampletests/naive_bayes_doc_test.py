...
class ClassifierTest(unittest.TestCase):
    ...
    def test_model_class_doc(self):
        """Generate a naive bayes dataset, train a model and verify"""
        # Naive bayes is a machine learning algorithm
        # We can use it to classify some item with properties into a group
        # probabilistically The general work flow is to generate a dataset
