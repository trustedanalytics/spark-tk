...
class NumericalStatisticsSampleFormulasITest extends TestingSparkContextWordSpec with Matchers {
  ...
  "NumericalStatistics mean" should {
    "handle data with integer frequencies" in new NumericalStatisticsTestSampleFormulas {
      val testMean = numericalStatisticsFrequencies.weightedMean

      Math.abs(testMean - expectedMeanFrequencies) should be < epsilon
    }

    "handle data with inverse probability weights" in new NumericalStatisticsTestSampleFormulas {
  ...
  "NumericalStatistics geometricMean" should {
    "handle data with integer frequencies" in new NumericalStatisticsTestSampleFormulas {
  ...
  "NumericalStatistics variance" should {
    "handle data with integer frequencies" in new NumericalStatisticsTestSampleFormulas {
    ...
    "handle data with fractional weights" in new NumericalStatisticsTestSampleFormulas {
  ...
  "NumericalStatistics standard deviation" should {
    "handle data with integer frequencies" in new NumericalStatisticsTestSampleFormulas {
  ...
  "NumericalStatistics mean confidence lower" should {
    "handle data with integer frequencies" in new NumericalStatisticsTestSampleFormulas {
  ...
  "NumericalStatistics mean confidence upper" should {
    "handle data with integer frequencies" in new NumericalStatisticsTestSampleFormulas {
  ...
  "NumericalStatistics max" should {
    "handle data with integer frequencies" in new NumericalStatisticsTestSampleFormulas {
  ...
  "NumericalStatistics min" should {
    "handle data with integer frequencies" in new NumericalStatisticsTestSampleFormulas {
  ...
  "NumericalStatistics count" should {
    "handle data with integer frequencies" in new NumericalStatisticsTestSampleFormulas {
  ...
  "NumericalStatistics total weight" should {
    "handle data with integer frequencies" in new NumericalStatisticsTestSampleFormulas {
