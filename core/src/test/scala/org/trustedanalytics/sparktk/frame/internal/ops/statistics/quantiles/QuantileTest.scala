...
class QuantileTest extends WordSpec with Matchers {
  "25th quantile" should {
    "be 0.5 * x2 + 0.5 * x3 from 10 elements" in {
  ...
  "0th, 95th and 99st quantile" should {
    "have mapping for element and mapping" in {
