...
class QuantileITest extends TestingSparkContextWordSpec with Matchers {
  "QuantilesFunctions.quantiles" should {
    "return the correct values with a small data set" in {
    ...
    //  "return the correct values with a large data set" in {
    //
