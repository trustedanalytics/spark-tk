...
def loopy_belief_propagation(self, prior, edge_weight, max_iterations=10):
    ...
    --------
        ...
        >>> result.inspect() 
        [#]  id  label  prior_val  was_labeled  Posterior
        =================================================================================
        [0]   1    1.0  0.7 0.3              1  [0.9883347610773112,0.011665238922688819]
        [1]   2    1.0  0.7 0.3              1  [0.9743014865548763,0.025698513445123698]
        [2]   3    5.0  0.7 0.3              0  [0.9396772870897875,0.06032271291021254]
        [3]   4    5.0  0.7 0.3              0  [0.9319529856190276,0.06804701438097235]
        [4]   5    5.0  0.7 0.3              1  [0.8506957305238876,0.1493042694761125]
