...
def cross_validate(frame, model_type, parameters, num_folds=3, verbosity=False, tc=TkContext.implicit):
    """
    Cross-validation
    ...
    return ClassificationCrossValidateValue(fold_result, verbosity)
