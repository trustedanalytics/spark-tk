...
def export_to_json(self, folder_name, count=4, offset=0):
    """
    Write current frame to HDFS in csv format.

    :param: folder_name: The HDFS folder path where the files will be created.
    ...
    """
    self._scala.exportToJson(folder_name, count, offset)
