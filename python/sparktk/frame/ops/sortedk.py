...
def sorted_k(self, k, column_names_and_ascending, reduce_tree_depth = 2):
    ...
    :param column_names_and_ascending: Column names to sort by, and true to sort column
                                       by ascending order, or false for descending order.
    :param reduce_tree_depth: Advanced tuning parameter which determines the depth of the
