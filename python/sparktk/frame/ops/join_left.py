def join_left(self,
    ...
    >>> composite_join_left = country_codes_frame.join_left(country_names_frame, ['col_0', 'col_2'])
    <progress>

    >>> composite_join_left.inspect()
    [#]  col_0_L  col_1_L  col_2_L  col_1_R
    ========================================
    [0]        1      354  a        Iceland
    [1]        1      354  a        Ice-land
    [2]        2       91  a        None
    ...
    return self._tc.to_frame(self._scala.joinLeft(right._scala,
