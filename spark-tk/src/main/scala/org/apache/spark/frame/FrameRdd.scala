...
import org.trustedanalytics.at.rdd.RddUtils
import org.trustedanalytics.at.schema.DataTypes.{ float64, float32, int64, int32 }
...
object FrameRdd {
   ...
   */
  def sparkDataTypeToSchemaDataType(dataType: org.apache.spark.sql.types.DataType): org.trustedanalytics.at.schema.DataTypes.DataType = {
   ...
   * @return a DataType
   */
  def sparkDataTypeToSchemaDataType(sparkDataType: String): org.trustedanalytics.at.schema.DataTypes.DataType = {
